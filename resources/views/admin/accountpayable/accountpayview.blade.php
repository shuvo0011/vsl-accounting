...
<div class="content-wrapper">
    ...
    <div>
        <form action="{{ route('admin.accountpayable') }}" method="POST">
            @csrf
            <div class="card-body">
                <div class="row">
                    <div class="form-group col-3">
                        <label for="month"> Expense Month </label>
                    ...
                    <div class="form-group col-3">
                        ...
                        <select name="glhead" id="glhead" class="form-control">
                    ...
                    <div class="form-group col-3">
                        ...
                        <input type="number" class="form-control" step="any" name="amount" id="amount" placeholder="000.00">
                    </div>
                </div>
                <div id="" class="row">
                    <div class="form-group col-3">
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td> {{ $row->officerid->officer_name}}</td>
                        ...
                        <td>
                            ...
                            @else
                            <select name="status" id="{{'status'.$row->id}}" class="form-control" onchange="paidunpaid({{$row->id}}, {{$row->officer}} ,{{$row->amount}},{{$row->glhead}},{{$row->remark}})">
...
<script>
    function paidunpaid(id, officer, amount, glcode, remark) {

        $.ajax({
            url: "{{ route('admin.accountPayUpdate') }}",
            data: {
                id,
                amount,
                officer,
